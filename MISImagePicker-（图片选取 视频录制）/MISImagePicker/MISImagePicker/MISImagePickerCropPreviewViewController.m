...
- (UIView *)footerView {
	if (!_footerView) {
		...
		[rotateBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerRotate"] forState:UIControlStateNormal];
		[rotateBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerRotateHL"] forState:UIControlStateHighlighted];
		...
		[retakeBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerRetack"] forState:UIControlStateNormal];
		[retakeBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerRetackHL"] forState:UIControlStateHighlighted];
		...
		[finishBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerCropFinish"] forState:UIControlStateNormal];
		[finishBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerCropFinishHL"] forState:UIControlStateHighlighted];
