...
+ (UIImage *)checkBtnImage {
	return [UIImage imageNamed:@"MISImagePicker.bundle/MISPhotoThumbCheck"];
}
...
+ (UIImage *)checkBtnHLImage {
	return [UIImage imageNamed:@"MISImagePicker.bundle/MISPhotoThumbCheckHL"];
}
...
+ (UIImage *)previewNavigationBackBtnImage {
	return [UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerButtonBack"];
}
