...
- (UIButton *)cameraBtn {
	if (!_cameraBtn) {
		...
		[_cameraBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerCamera"] forState:UIControlStateNormal];
		[_cameraBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerCameraHL"] forState:UIControlStateHighlighted];
...
- (UIButton *)cancelBtn {
	if (!_cancelBtn) {
		...
		[_cancelBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerClose"] forState:UIControlStateNormal];
		[_cancelBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerCloseHL"] forState:UIControlStateHighlighted];
...
- (UIButton *)girdBtn {
	if (!_girdBtn) {
		...
		[_girdBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerGridOn"] forState:UIControlStateNormal];
		[_girdBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerGridOnHL"] forState:UIControlStateHighlighted];
...
- (UIButton *)lightBtn {
	if (!_lightBtn) {
		...
		[_lightBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerFlashlightOff"] forState:UIControlStateNormal];
		[_lightBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerFlashlightOffHL"] forState:UIControlStateHighlighted];
...
- (UIButton *)albumBtn {
	if (!_albumBtn) {
		...
		[_albumBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerAlbum"] forState:UIControlStateNormal];
...
- (void)setFlashlightOn:(BOOL)flashlightOn {
	if (flashlightOn) {
		[_lightBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerFlashlightOn"] forState:UIControlStateNormal];
...
- (void)tapGrid {
	...
	if (self.girdView.hidden) {
		[self.girdBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerGridOff"] forState:UIControlStateNormal];
		[self.girdBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerGridOffHL"] forState:UIControlStateHighlighted];
	}else {
		[self.girdBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerGridOn"] forState:UIControlStateNormal];
		[self.girdBtn setImage:[UIImage imageNamed:@"MISImagePicker.bundle/MISImagePickerGridOnHL"] forState:UIControlStateHighlighted];
	}
}
